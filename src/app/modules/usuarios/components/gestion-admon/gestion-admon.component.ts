...
import { PERMISOS_ADMIN, GESTION_USUARIOS, GESTION_ETAPAS, GESTION_PAGOS, GESTION_CONV, GESTION_EVAL, GESTION_DOC, sinAcceso, comprobarPermisos } from '@shared/admin-permissions/permissions';
...
export class GestionAdmonComponent implements OnInit, AfterViewInit {
  ...
  constructor(private _adminService: AdminService, private _toast:ToastrService, public dialog: MatDialog, 
    ...
    //Comprobar Permisos
    if(this.usuario.rol != 'root' && !comprobarPermisos(this.usuario, GESTION_USUARIOS, router)) sinAcceso(router);
