...
export const DOCUMENTACION_CORRECCION = new Alert(NAME_DOCUMENTACION_CORRECCION, "Corregir documentación.", ListLinks.SUBIR_DOCUMENTACION.url, TipoAlert.ALERTA);
