...
export const DOCUMENTACION_CORRECCION = new Alert(NAME_DOCUMENTACION_CORRECCION, "Corregir documentación.", ListLinks.SUBIR_DOCUMENTACION.url, TipoAlert.AVISO, true);
...
export const EVALUACION_VALIDO = new Alert(NAME_EVALUACION_VALIDO, "Estado de evaluación valido.", ListLinks.RESULTADOS.url, TipoAlert.AVISO, true);
ALERTAS.set(NAME_EVALUACION_VALIDO, EVALUACION_VALIDO);

const NAME_EVALUACION_NO_VALIDO = "EVALUACION_NO_VALIDO";
export const EVALUACION_NO_VALIDO = new Alert(NAME_EVALUACION_NO_VALIDO, "Estado de evaluación valido.", ListLinks.RESULTADOS.url, TipoAlert.CONFIRMACION, true);
